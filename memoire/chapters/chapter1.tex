...
\hline
Cloudflare~\cite{cloudflare2025}       & 348~Tbps (réseau global) & L3/L4 + L7 (WAF intégré) & Always-on (automatique) \\
\hline
AWS Shield Advanced~\cite{awsshield2024} & Élastique (infra AWS) & L3/L4 + L7 (avec WAF) & Always-on + sur demande \\
\hline
Azure DDoS Protection~\cite{azureddos2024} & Élastique (infra Azure) & L3/L4 & Always-on \\
\hline
Google Cloud Armor~\cite{googlearmor2024} & Élastique (infra Google) & L7 (HTTP/HTTPS) & Always-on \\
\hline
